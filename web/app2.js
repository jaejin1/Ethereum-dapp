...
var MyContractJSON = require("../truffle/build/contracts/Vote.json");
...
Mycontract2.deployed().then(function(instance){
	return instance.addvoter(0x6ea45f74c9803a9c3403c400975424e5825dfb70,{from: account});
...
Mycontract2.deployed().then(function(instance){
	return instance.getNumOfvoter();
}).then(function(result){
	console.log(result.toNumber());
});
*/
Mycontract2.deployed().then(function(instance){
	return instance.vote(0x6ea45f74c9803a9c3403c400975424e5825dfb70,0x6ea45f74c9803a9c3403c400975424e5825dfb70, {from: account, gas: 470000});
}).then(function(result){
	console.log(result);
});
